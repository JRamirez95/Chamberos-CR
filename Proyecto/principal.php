...
<body class="home">
    ...
    <div class="swiper-container main-slider" id="myCarousel">
        <div class="swiper-wrapper">
            <div class="swiper-slide slider-bg-position" style="background:url('https://marketcon.files.wordpress.com/2015/05/ubicacic3b3n-como-estrategia-de-marketing.jpg')"
                data-hash="slide1">
    ...
    <section class="service-sec" id="benefits">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-6 text-sm-center service-block">
                            <i class="fa fa-one" aria-hidden="true">1</i>
                            <h3>Descubre tu ChamBero ideal</h3>
                            <p>Encuentra personas expertas en temas de jardinería, pintura, albañilería y hasta plomería, que
                                se adapten a tu presupuesto.</p>
                        </div>
                        <div class="col-md-6 text-sm-center service-block">
                            <i class="fa fa-two" aria-hidden="true">2</i>
                            <h3>Haz tu reservación</h3>
                            <p>Compara perfiles, lee los comentarios de otros usuarios y paga de manera segura a través de nuestra
                                plataforma.
                            </p>
                        </div>
                        <div class="col-md-6 text-sm-center service-block">
                            <i class="fa fa-" aria-hidden="true">3</i>
                            <h3>¡Vive!</h3>
                            <p>Deja las tareas de tu casa en nuestras manos y dedica tu tiempo a lo que realmente importa.</p>
                        </div>
                        <div class="col-md-6 text-sm-center service-block">
                            <i class="fa fa-four" aria-hidden="true">4</i>
                            <h3>Disfruta</h3>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <img src="http://www.serfaci.com/wp-content/uploads/2016/08/home.jpg" class="img-fluid" /> </div>
            </div>
    ...
    <section class=" parallax-section">
            ...
            <h2 class="text-center" style="color:black;"><strong>Ellos son algunos de las mejores Chamberos</strong></h2>
