            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="dashvariants" class="collapse list-unstyled">
                        ...
                        <li>
                            <a href="login.php"> <i class="fa fa-video-camera"></i>Videos</a>
                        </li>
                    </ul>
                </li>
                <!-- <li> <a href="#"> <i class="fa fa-photo"></i>Fotos</a></li>-->
                <li>
                    <a href="Parametros.php"> <i class="fa fa-cog"></i>Parametros</a>
                </li>
                <li>
                    <a href="editarPerfil.php"> <i class="fa fa-pencil"></i>Editar Perfil</a>
                </li>
                <li>
                    <a href="login.php"> <i class="fa fa-sign-out"></i>Cerrar Sesion</a>
                </li>
            </ul>
        </nav>
